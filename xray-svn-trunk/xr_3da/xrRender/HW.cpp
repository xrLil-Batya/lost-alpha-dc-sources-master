...
//#endif
	...
	{
		//SetWindowLong(m_hWnd, GWL_STYLE, dwWindowStyle = (WS_OVERLAPPEDWINDOW | WS_CLIPSIBLINGS | WS_CLIPCHILDREN));
		SetWindowLong(m_hWnd, GWL_STYLE, dwWindowStyle = (WS_POPUP | WS_VISIBLE));
		//SetWindowLong(m_hWnd, GWL_STYLE, dwWindowStyle = (WS_CLIPSIBLINGS | WS_CLIPCHILDREN | WS_POPUP));
