	...
	case GEG_PLAYER_ACTIVATEARTEFACT:
		{
			...
			{
			case GEG_PLAYER_ITEM2SLOT:
#pragma todo("tatarinrafa: Не могу понять зачем нам еще один вызов функции Slot. Еще и параллельный. Закоментил так, как вызывает баги с детектором|There is already another call of Slot function in inventory.cpp, commented because caused bugs with detector toggling")
