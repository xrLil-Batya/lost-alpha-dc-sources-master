...
//	add<CSE_SpawnGroup>											(CLSID_AI_SPAWN_GROUP			,"spawn_group");
	...
	// Artefacts
	//ADD(CArtefact				,CSE_ALifeItemArtefact			,CLSID_W_ARTEFACT				,"wpn_artefact");
	...
	ADD(CWeaponZoomable			,CSE_ALifeItemWeaponMagazined	,CLSID_OBJECT_W_ZOOMABLE		,"wpn_zoomable");
	...
	// Detectors
	ADD(CSimpleDetector			,CSE_ALifeItemDetector			,CLSID_AF_DET_SIMPLE			,"af_detector_simple");
	ADD(CSimpleDetectorR		,CSE_ALifeItemDetector			,CLSID_DETECTOR_SIMPLE			,"device_detector_simple");
	ADD(CAdvancedDetector		,CSE_ALifeItemDetector			,CLSID_AF_DET_ADV				,"af_detector_adv");
	ADD(CEliteDetector			,CSE_ALifeItemDetector			,CLSID_AF_DET_ELITE				,"af_detector_elite");
...
//	ADD(CTrigger				,CSE_Trigger					,CLSID_OBJECT_TRIGGER			,"trigger");
	...
	ADD(CGraviArtefact			,CSE_ALifeItemArtefact			,TEXT2CLSID("SCRPTART")			,"artefact_s");
	...
	ADD(CWeaponZoomable			,CSE_ALifeItemWeaponMagazined	,TEXT2CLSID("WP_ZOOM")			,"wpn_zoomable_s");
	...
	ADD(CHairsZone				,CSE_ALifeZoneVisual			,TEXT2CLSID("ZS_RUSTY")			,"zone_rustyhair_s");
	ADD(CHairsZone				,CSE_ALifeAnomalousZone			,TEXT2CLSID("ZS_NOGRA")			,"zone_nogravity_s");
	...
	ADD(CMosquitoBald			,CSE_ALifeAnomalousZone			,TEXT2CLSID("ZS_ELECT")			,"zone_elec_s");
	ADD(CMosquitoBald			,CSE_ALifeAnomalousZone			,TEXT2CLSID("ZS_ZHARK")			,"zone_zhar_s");
	ADD(CMincer					,CSE_ALifeAnomalousZone			,TEXT2CLSID("ZS_BUZZ")			,"zone_buzz_s");
	ADD(CZoneMine				,CSE_ALifeAnomalousZone			,TEXT2CLSID("Z_MINES")			,"zone_mine_s");
	ADD(CZoneCampfire			,CSE_ALifeAnomalousZone			,TEXT2CLSID("Z_FLAME")			,"zone_flame_s");
