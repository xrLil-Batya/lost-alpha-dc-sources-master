...
public:
	...
	IC BOOL						HudCollideEnabled		()	const			{ return m_huditem_flags.test(fl_collide_hud);}
	IC BOOL						HudStrafeInertionEnabled		()	const			{ return m_huditem_flags.test(fl_strafe_hud);}
	IC BOOL						HudBobbingEnabled			()	const			{ return m_huditem_flags.test(fl_bobbing_hud);}
...
protected:
	...
	IC void						EnableHudCollide		(BOOL B)		{ m_huditem_flags.set(fl_collide_hud, B);}
	IC void						EnableHudStrafeInertion		(BOOL B)		{ m_huditem_flags.set(fl_strafe_hud, B);}
	IC void						EnableHudBobbing		(BOOL B)		{ m_huditem_flags.set(fl_bobbing_hud, B);}
