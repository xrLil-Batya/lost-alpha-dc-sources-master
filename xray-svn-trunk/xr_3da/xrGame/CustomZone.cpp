...
//////////////////////////////////////////////////////////////////////////
	...
	if(m_zone_flags.test(eSpawnBlowoutArtefacts) )
	{
		...
		m_fArtefactSpawnProbability		= READ_IF_EXISTS(pSettings, r_float, section,	"artefact_spawn_probability", 0.0);
		...
		m_fThrowOutPower				= READ_IF_EXISTS(pSettings, r_float, section, "throw_out_power", 0.0);
		//m_fThrowOutPower = pSettings->r_float (section,			"throw_out_power");
		m_fArtefactSpawnHeight			= READ_IF_EXISTS(pSettings, r_float, section, "artefact_spawn_height", 0.0);
