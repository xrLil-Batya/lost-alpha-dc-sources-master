...
void UIUpgrade::Update()
{
	...
	m_point->Show(get_upgrade() && get_upgrade()->get_highlight());
}
...
void CUIUpgradePoint::load_from_xml(CUIXml& ui_xml, int i_cell)
{
	...
	float point_y = ui_xml.ReadAttribFlt("cell", i_cell, "point_y", 0.0f); point_y -= 100.0f;
