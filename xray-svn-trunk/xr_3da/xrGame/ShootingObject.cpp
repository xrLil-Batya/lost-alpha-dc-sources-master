...
void CShootingObject::LoadFireParams	(LPCSTR section, LPCSTR prefix)
{
	...
	s_sHitPowerCritical = pSettings->r_string_wb(section, strconcat(sizeof(full_name_critical), full_name_critical, prefix, "hit_power_critical"));
