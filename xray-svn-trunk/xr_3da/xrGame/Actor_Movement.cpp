			...
			if (scale>EPS)	{
				...
				if (bAccelerated)
				{
					if (mstate_real&mcBack)
						...
						scale *= m_fRunFactor + m_fRunFactorAdditional;//tatarinrafa: added additional run speed for arts and outfit
				}
				else
				{
					if (mstate_real&mcBack)
				...
				if (mstate_real&mcSprint)	scale *= m_fSprintFactor + m_fSprintFactorAdditional;//tatarinrafa: added additional sprint speed for arts and outfit
