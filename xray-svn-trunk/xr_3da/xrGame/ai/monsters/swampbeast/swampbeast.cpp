...
CAI_SwampBeast::CAI_SwampBeast()
{
	StateMan = new CStateManagerSwampBeast(this);
...
BOOL CAI_SwampBeast::net_Spawn (CSE_Abstract* DC) 
{
...
void CAI_SwampBeast::Load(LPCSTR section)
{
...
void CAI_SwampBeast::CheckSpecParams(u32 spec_params)
{
...
bool CAI_SwampBeast::ConeSphereIntersection(Fvector ConeVertex, float ConeAngle, Fvector ConeDir, Fvector SphereCenter, float SphereRadius)
{
