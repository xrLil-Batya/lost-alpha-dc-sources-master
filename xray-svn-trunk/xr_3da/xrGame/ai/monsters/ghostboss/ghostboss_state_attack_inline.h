...
{
	add_state(eStateGhostBossAttack_Tele, new CStateGhostBossAttackTele<_Object>(obj));
	add_state(eStateGhostBossAttack_Gravi, new CStateGhostBossAttackGravi<_Object>(obj));
	add_state(eStateGhostBossAttack_Melee, new CStateGhostBossAttackMelee<_Object>(obj));
	
	add_state(eStateGhostBossAttack_FaceEnemy, new CStateMonsterLookToPoint<_Object>(obj));
	add_state(eStateGhostBossAttack_RunAround, new CStateGhostBossAttackRunAround<_Object>(obj));
