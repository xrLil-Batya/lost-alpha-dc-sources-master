...
CStateManagerBloodsucker::CStateManagerBloodsucker(CAI_Bloodsucker *monster) : inherited(monster)
{
	...
	add_state(eStateCustom_Vampire, new CStateBloodsuckerVampire<CAI_Bloodsucker>(monster));
  //add_state(eStateCustom_Vampire,		new CStateBloodsuckerVampireExecute<CAI_Bloodsucker>(monster));
}
