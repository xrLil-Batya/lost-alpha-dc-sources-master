...
void CWeaponPistol::PlayAnimShow	()
{
	...
	if(iAmmoElapsed==0)
		PlayHUDMotion("anim_show_empty", FALSE, this, GetState());
	else
...
{
	if(iAmmoElapsed==0)
		PlayHUDMotion	("anim_bore_empty", TRUE, this, GetState());
	else
...
{	
	...
	if(iAmmoElapsed==0)
	{
		PlayHUDMotion("anim_reload_empty", TRUE, this, GetState());
	}else{
...
void CWeaponPistol::PlayAnimHide()
{
	...
	if(iAmmoElapsed==0) 
	{
		...
		PlayHUDMotion		("anim_hide_empty" , TRUE, this, GetState());
	} 
	else 
...
void CWeaponPistol::PlayAnimShoot	()
{
	...
	{
		PlayHUDMotion("anim_shot_l", FALSE, this, GetState()); 
	}
}
