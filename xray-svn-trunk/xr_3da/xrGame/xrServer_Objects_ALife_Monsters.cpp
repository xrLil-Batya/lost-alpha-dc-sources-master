...
void setup_location_types_section(GameGraph::TERRAIN_VECTOR &m_vertex_types, const CInifile *ini, LPCSTR section)
{
...
void setup_location_types(GameGraph::TERRAIN_VECTOR &m_vertex_types, const CInifile *ini, LPCSTR string)
{
