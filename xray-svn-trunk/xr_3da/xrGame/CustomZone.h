...
//	bool					m_bSpawnBlowoutArtefacts;
	...
	//tatarinrafa:Lets add an oportunity of spawning several arts
	u8						m_iArtSpawnCicles;
	...
	bool					SpawnArtefactWhenBlewOut;
	xr_vector<CEntityAlive*>	affectedgameobjects;
