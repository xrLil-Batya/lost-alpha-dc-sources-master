...
public:
	...
	bool						IsServerDemo()	{ return (m_sDemoHeader.bServerClient != 0); Msg("IsServerDemo() Remove me if i never apear"); };
	bool						IsClientDemo()	{ return (m_sDemoHeader.bServerClient == 0); Msg("IsClientDemo() Remove me if i never apear"); };
