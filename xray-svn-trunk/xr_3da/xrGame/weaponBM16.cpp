...
void CWeaponBM16::PlayAnimShoot()
{
	...
	{
	case 1:
		PlayHUDMotion("anim_shot_1",FALSE,this,GetState());
		break;
	case 2:
		PlayHUDMotion("anim_shot_2",FALSE,this,GetState());
		break;
	}
}
...
void CWeaponBM16::PlayAnimShow()
{
	...
	{
	case 0:
		PlayHUDMotion("anim_show_0",TRUE,this,GetState());
		break;
	case 1:
		PlayHUDMotion("anim_show_1",TRUE,this,GetState());
		break;
	case 2:
		PlayHUDMotion("anim_show_2",TRUE,this,GetState());
		break;
	}
}
...
void CWeaponBM16::PlayAnimHide()
{
	...
	{
	case 0:
		PlayHUDMotion("anim_hide_0",TRUE,this,GetState());
		break;
	case 1:
		PlayHUDMotion("anim_hide_1",TRUE,this,GetState());
		break;
	case 2:
		PlayHUDMotion("anim_hide_2",TRUE,this,GetState());
		break;
	}
}
...
void CWeaponBM16::PlayAnimBore()
{
	...
	{
	case 0:
		PlayHUDMotion("anim_bore_0",TRUE,this,GetState());
		break;
	case 1:
		PlayHUDMotion("anim_bore_1",TRUE,this,GetState());
		break;
	case 2:
		PlayHUDMotion("anim_bore_2",TRUE,this,GetState());
		break;
	}
}
...
void CWeaponBM16::PlayAnimReload()
{
	...
	if((m_magazine.size()==1 || !b_both) && 
		...
		PlayHUDMotion("anim_reload_2",TRUE,this,GetState());
}
...
void  CWeaponBM16::PlayAnimIdleMoving()
{
	...
	{
	case 0:
		PlayHUDMotion("anim_idle_moving_0",TRUE,this,GetState());
		break;
	case 1:
...
void  CWeaponBM16::PlayAnimIdleSprint()
{
	...
	{
	case 0:
		PlayHUDMotion("anim_idle_sprint_0",TRUE,this,GetState());
		break;
	case 1:
