...
#define CLSID_W_ARTEFACT			MK_CLSID('W','A','R','T','E','F','C','T')
...
#define CLSID_AF_DET_SIMPLE			MK_CLSID('D','_','S','A','F','D','E','T')
#define CLSID_AF_DET_ADV			MK_CLSID('D','_','A','A','F','D','E','T')
#define CLSID_AF_DET_ELITE			MK_CLSID('D','_','E','A','F','D','E','T')
