...
#include "..\..\..\..\SDK\MagicSoftware\Sdk\Include\MgcCont3DBox.h"         
#include "..\..\..\..\SDK\MagicSoftware\Sdk\Include\MgcCont3DMinBox.h"         
...
//.	            VERIFY		(!motion->GetMotionFlags(bone_id).is(st_BoneMotion::flWorldOrient));
        ...
        for (itm_idx=0; itm_idx<b_lst.size(); itm_idx++){
			...
			Msg("exporting [%s] as 8-bit [%f]", motion->Name(), St.magnitude());
